...
const JobCard = (props) => {
  ...
  return (
    <div className="bg-white small-card shadow-md rounded-lg mb-3 flex flex-col w-full hover:shadow-lg hover:-translate-y-1 transition ease-in-out delay-10">
      <div className="flex flex-row border-b pb-5">
        ...
        <div className="flex flex-col px-4">
          ...
          <div className="flex flex-row items-center">
            <span className="mr-2 text-green-500 font-semibold tracking-tighter">{timeAgo}</span>
      ...
      <div className="flex flex-row overflow-hidden">
        {techstack.map((item, index) => <div key={index} ><JobcardTag   item={item}/> </div>)}
      </div>
    </div>
  );
};
